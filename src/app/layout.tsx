...
const siteVerificationMeta: Record<string, string> = {};

if (process.env.BAIDU_SITE_VERIFICATION) {
  siteVerificationMeta["baidu-site-verification"] = process.env.BAIDU_SITE_VERIFICATION;
}

if (process.env.BING_MS_VALIDATE) {
  siteVerificationMeta["msvalidate.01"] = process.env.BING_MS_VALIDATE;
}

if (process.env.QIHOO360_SITE_VERIFICATION) {
  siteVerificationMeta["360-site-verification"] = process.env.QIHOO360_SITE_VERIFICATION;
}

if (process.env.SOGOU_SITE_VERIFICATION) {
  siteVerificationMeta["sogou_site_verification"] = process.env.SOGOU_SITE_VERIFICATION;
}

export const metadata: Metadata = {
  title: "重庆炬陆昇科技有限公司 - 万州美团充电宝｜万州收银系统｜本地上门服务团队",
  description:
    "重庆炬陆昇科技有限公司，立足万州，服务渝东北区域商家，提供万州美团充电宝、万州收银系统、万州电动车充电桩、万州无人零售货柜等本地落地服务。",
  keywords:
    "万州,万州美团充电宝,万州充电宝,充电宝,渝东北充电宝,万州收银,万州收银系统,万州美团收银系统,美团收银系统,万州无人零售柜,无人零售柜,万州充电桩,充电桩,重庆炬陆昇科技",
  openGraph: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description:
      "立足万州，专注渝东北本地商家智能设备服务，提供万州美团充电宝、万州收银系统、万州充电桩、万州无人零售柜等业务支持。",
    keywords:
      "万州美团充电宝, 万州充电宝, 渝东北充电宝, 万州收银系统, 万州美团收银系统, 万州无人零售柜, 万州充电桩",
    address: {
      "@type": "PostalAddress",
